...
export default function InventoryPage() {
  ...
  const [itemForm, setItemForm] = useState({ name: '', code: '', unitId: '', groupId: '', hsnSac: '', standardRate: 0, reorderLevel: 0 });
  const [movementForm, setMovementForm] = useState({ itemId: '', warehouseId: '', type: 'OPENING', quantity: 0, rate: 0, movementDate: new Date().toISOString().slice(0, 10), referenceNo: '', narration: '' });
  ...
  async function loadData() {
    const [unitData, groupData, itemData, companyData, movementData, summaryData] = await Promise.all([
      api('/inventory/units'),
